		...
		if (!$Server::LAN)
		{
			if (%brickGroup.numPlayerVehicles >= $Pref::Server::Quota::Player)
			{
				if (%client.brickGroup == %brickGroup)
				{
					...
					{
						commandToClient (%client, 'CenterPrint', "\c1\c0You already have " @ $Pref::Server::Quota::Player @ " player-vehicles", 2);
					}
				}
				...
				{
					commandToClient (%client, 'CenterPrint', "\c1\c0" @ %brickGroup.name @ " already has " @ $Pref::Server::Quota::Player @ " player-vehicles", 2);
				}
				return;
			}
		}
		...
		if (!$Server::LAN)
		{
			if (%brickGroup.numPhysVehicles >= $Pref::Server::Quota::Vehicle)
			{
				if (%client.brickGroup == %brickGroup)
				{
					...
					{
						commandToClient (%client, 'CenterPrint', "\c1\c0You already have " @ $Pref::Server::Quota::Vehicle @ " physics-vehicles", 2);
					}
				}
				...
				{
					commandToClient (%client, 'CenterPrint', "\c1\c0" @ %brickGroup.name @ " already has " @ $Pref::Server::Quota::Vehicle @ " physics-vehicles", 2);
				}
				return;
			}
		}
