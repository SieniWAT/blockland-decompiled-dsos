...
function OptPlayerHeadMenu::onSelect (%this, %null, %text)
{
...
function OptGraphicsDriverMenu::onSelect (%this, %null, %text)
{
...
function OptAudioDriverList::onSelect (%this, %null, %text)
{
	if (%text $= "")
	{
		return;
