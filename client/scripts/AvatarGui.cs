...
function AvatarGui::onWake (%null)
{
...
function AvatarGui::onSleep (%null)
{
...
function AvatarGui_CreateColorMenu (%prefString, %colorList, %xPos, %yPos)
{
	...
	while (%colorIndex !$= "")
	{
		...
		%itemCount += 1;
		%colorIndex = getWord (%colorList, %itemCount);
	}
...
function Avatar_SetFace (%index, %null)
{
...
function Avatar_SetDecal (%index, %null)
{
...
function Avatar_SetPack (%index, %null)
{
...
function Avatar_SetHat (%index, %null)
{
...
function Avatar_SetAccent (%index, %null)
{
